...
class ImageFieldTest extends EntityBrowserWebDriverTestBase {
  ...
  public function testDragAndDropAndRemove() {
    ...
    $file1_handle = $this->assertSession()
      ->elementExists('xpath', "(//a[contains(@class, 'tabledrag-handle')])[1]");
    $file2 = $this->assertSession()
      ->elementExists('xpath', "(//tr[contains(@class, 'item-container')])[2]");
    ...
    $file3 = $this->assertSession()
      ->elementExists('xpath', "(//tr[contains(@class, 'item-container')])[2]");
    $this->dragDropElement($file3, 160, 0);

    $file3_handle = $this->assertSession()
      ->elementExists('xpath', "(//a[contains(@class, 'tabledrag-handle')])[2]");
    $file4 = $this->assertSession()
      ->elementExists('xpath', "(//tr[contains(@class, 'item-container')])[3]");
    ...
    $file5 = $this->assertSession()
      ->elementExists('xpath', "(//tr[contains(@class, 'item-container')])[3]");
    $this->dragDropElement($file5, 160, 0);

    $file5_handle = $this->assertSession()
      ->elementExists('xpath', "(//a[contains(@class, 'tabledrag-handle')])[3]");
    $file6 = $this->assertSession()
      ->elementExists('xpath', "(//tr[contains(@class, 'item-container')])[4]");
    ...
    $file2_handle = $this->assertSession()
      ->elementExists('xpath', "(//a[contains(@class, 'tabledrag-handle')])[1]");
    $file8 = $this->assertSession()
      ->elementExists('xpath', "(//tr[contains(@class, 'item-container')])[5]");
