...
class ConstraintsTest extends UnitTestCase {
  ...
  public function embedCodeProvider() {
    return [
      'valid Pin URL' => ['https://www.pinterest.com/pin/424605071105031218/', 0],
      'valid Board URL' => ['https://www.pinterest.com/pusheen/stuff-%2B-things/', 0],
      'valid Board Section URL' => ['https://www.pinterest.com/pusheen/stuff-%2B-things/refinement-%2B-precision/', 0],
      'valid user URL' => ['https://www.pinterest.com/pusheen/', 0],
    ];
  }
