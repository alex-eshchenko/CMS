<?php
function gavias_monte_preprocess_node(&$variables) {
      ...
      if($post_format == 'video' || $post_format == 'audio'){
         try{
            ...
            if(isset($field_post_embed->value) && $field_post_embed->value){
               ...
               $iframe = $autoembed->my_remote_get($field_post_embed->value);
            }else{
               $iframe = '';
               $post_format = 'standard';
            }
...
function gavias_monte_preprocess_field(&$variables, $hook) {
  $element = $variables['element'];
}  

function gavias_monte_preprocess_breadcrumb(&$variables){
