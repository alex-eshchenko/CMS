<?php
function gavias_monte_preprocess_views_view_fields__featured_videos(&$vars) {
   $fields = $vars['fields'];
   $row = $vars['row'];
   $thumbnail = '';
   $thumbnail_url = strip_tags($fields['uri']->content);
   $vars['thumbnail_url'] = trim($thumbnail_url);
}

function gavias_monte_preprocess_views_view_unformatted__taxonomy_term(&$variables){
...
function gavias_monte_preprocess_views_view_unformatted(&$variables) {
   $view = $variables['view'];
   $rows = $variables['rows'];
...
function gavias_monte_preprocess_views_view_grid(&$variables) {
   $view = $variables['view'];
   $rows = $variables['rows'];
   $style = $view->style_plugin;
   $options = $style->options;
...
function gavias_monte_preprocess_views_view_fields__testimonial_v1(&$vars) {
   $fields = $vars['fields'];
   $vars['iframe_video'] = '';
   try{
